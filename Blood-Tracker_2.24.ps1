...
$Version = "2.23.0" # Aktuelle Versionierung
...
$script:MarkerAliases = @{
    ...
    'C-reaktives Protein (CRP)'                 = @('CRP', 'hsCRP', 'hs-CRP', 'CRP hs', 'hochsensitives CRP', 'C-reaktives Protein', 'CRP hochsensitiv')
...
function Show-DataEntryForm {
    ...
    function Update-MarkerInputMode {
        # Steuert HIV-/Testosteron-Sonderfelder und die Info-Zeile.
    ...
    $markerComboBox.Add_TextUpdate({
        ...
        } elseif ($hivComboBox.Visible -or $testoUnitCombo.Visible) {
            Update-MarkerInputMode -MarkerName $null
        }
    })
